...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Condition', fields ['proxy_class']
        db.delete_unique(u'offer_condition', ['proxy_class'])


    def backwards(self, orm):
        # Adding unique constraint on 'Condition', fields ['proxy_class']
        db.create_unique(u'offer_condition', ['proxy_class'])
    ...
    models = {
        ...
        u'offer.condition': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'proxy_class': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'range': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['offer.Range']", 'null': 'True', 'blank': 'True'}),
