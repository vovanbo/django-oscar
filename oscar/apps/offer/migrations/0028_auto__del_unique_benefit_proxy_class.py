...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Benefit', fields ['proxy_class']
        db.delete_unique(u'offer_benefit', ['proxy_class'])


    def backwards(self, orm):
        # Adding unique constraint on 'Benefit', fields ['proxy_class']
        db.create_unique(u'offer_benefit', ['proxy_class'])
